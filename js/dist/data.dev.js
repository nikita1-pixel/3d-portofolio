...
var techStack = ["I build with React...", "I build with Next.js...", "I build with TypeScript...", "I build with Node.js...", "I build with PostgreSQL..."];
/* ---------- Skills (bento grid) ---------- */
...
var projects = [{
  ...
  description: "Designed and built a secure authentication system featuring Server-Side Rendering (SSR) for optimized performance. Developed robust backend logic to manage complex user inputs and identity protection modules.",
  highlights: ["Map interface for visualizing user activity and access patterns", "Custom-built identity protection algorithms to prevent unauthorized access"],
  ...
  description: "Developed a e-commerce platform using ReactJs to manage complex product transactions and user workflows. Implemented a dynamic product catalog system to ensure data integrity for inventory and pricing. Built a responsive user interface aligned with professional retail standards to enhance customer engagement",
  highlights: [],
  image: "",
  ...
  description: "Engineered a robust application demonstrating full Create, Read, Update, and Delete capabilities. Implemented efficient Database Management to handle persistent data storage and flow.",
  highlights: ["Dynamic product catalog system to manage inventory and pricing", "Responsive user interface designed to enhance customer engagement and drive sales"],
...
var experience = [{
  ...
  description: "Performed in-depth research and data-driven analysis to support team leads with decision-making information. Implemented Streamlined administrative transactions and improved process documentation to enhance efficiency. Managed digital assets and brand visibility while maintaining strict data integrity across platforms.",
  align: "left"
}, {
  ...
  description: "Optimized complex workflows and operational logic to reduce service latency. Identified and resolved process- level inaccuracies in cash flow and POS reconciliation. Consistently exceeded internal audit standards by adhering to organizational governance and technical standards",
  align: "right"
} // {
//     period: "2018 - 2020",
